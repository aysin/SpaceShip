...
def draw(canvas):
    ...
    canvas.draw_text('Lives: '+str(lives), (25,35), 30, "Blue")
    canvas.draw_text('Score: '+str(score), (680,35), 30, "Blue")
...
def rock_spawner():
    ...
    rock_vel2 = random.random() * .2 - .1
    a_rock = Sprite(rock_pos, rock_vel, 0, rock_vel2, asteroid_image, asteroid_info)
